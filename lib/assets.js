...
(function() {
  var BEFORE_DOT, ConnectAssets, EXPLICIT_PATH, REMOTE_PATH, Snockets, connectCache, crypto, cssCompilers, cssExts, endsWith, exports, fs, getExt, jsCompilers, libs, md5Filenamer, mkdirRecursive, parse, path, stripExt, timeEq, util, _;
  ...
  ConnectAssets = (function() {
    ...
    ConnectAssets.prototype.fixCSSUrlPaths = function(css) {
      var regex;
      regex = /url\((?!"\/|'\/|\/)[^\)]+\)/g;
